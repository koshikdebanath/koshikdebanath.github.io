...
**Tags:** Forensics, Explainable AI, Image Analysis, Python, Streamlit
...
_Replace the above image with your actual results screenshot or visualization._
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid path="/assets/img/educational/synthdetect.gif" title="SynthDetect Ultra: AI Image Forensics" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    SynthDetect Ultra: AI Image Forensics
...
- [Try Demo](https://gradient-field-detector.streamlit.app/)
- [Watch Demo](https://youtu.be/zwNUQgbRae4?si=6hqK_SFfL7r1oNNG)
