...
img: /assets/img/educational/ai-companion-plugin-install.gif
importance: 3
category: AI/ML
...
- **Quick access with `/ai` command**: Instantly invoke the AI assistant from anywhere in your notes.
- **Context-aware responses**: The plugin can use the content of your current page to provide more relevant answers.
...
![AI Companion Plugin Demo](/assets/img/educational/ai-companion-plugin-install.gif)
